...
struct VistaTexto: View {
    ...
    let titulo = "Título"
    let parrafo = "Este es un parrafo más largo que puede contener muchas líneas y caracteres. Lo vamos a alargar para que ocupe unas cuantas líneas. Este es un parrafo más largo que puede contener muchas líneas y caracteres. Lo vamos a alargar para que ocupe unas cuantas líneas."
