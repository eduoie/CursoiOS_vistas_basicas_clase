    ...
    var body: some View {
        VStack(spacing: 15) {
            Image("pajarito")
                ...
                // en este caso, CGSize se usa como vector de distancia, no como medidas de tamaño
                // Por tanto, admite valores negativos. Ej. (CGSize(width: -50, height: -100)
                .offset(mueveme ? CGSize(width: 100, height: 0) : CGSize(width: -100, height: 0))
                // easing functions: https://www.svgator.com/blog/easing-functions/
...
//                    }
            ...
            Button("Anima ambos rectángulos y la tortuga") {
